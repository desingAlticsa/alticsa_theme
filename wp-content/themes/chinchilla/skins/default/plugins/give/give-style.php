...
if ( ! function_exists( 'chinchilla_give_get_css' ) ) {
	add_filter( 'chinchilla_filter_get_css', 'chinchilla_give_get_css', 10, 2 );
	function chinchilla_give_get_css( $css, $args ) {
...
.give-wrap .give-card__progress .raised .goal-text{
    {$fonts['p_font-family']}
}
CSS;
		}
