...
if ( ! function_exists( 'chinchilla_gutenberg_get_css' ) ) {
	add_filter( 'chinchilla_filter_get_css', 'chinchilla_gutenberg_get_css', 10, 2 );
	function chinchilla_gutenberg_get_css( $css, $args ) {
