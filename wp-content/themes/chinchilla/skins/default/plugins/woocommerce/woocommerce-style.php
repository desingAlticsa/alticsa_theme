...
if ( ! function_exists( 'chinchilla_woocommerce_get_css' ) ) {
	add_filter( 'chinchilla_filter_get_css', 'chinchilla_woocommerce_get_css', 10, 2 );
	function chinchilla_woocommerce_get_css( $css, $args ) {
...
$fdir = chinchilla_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
