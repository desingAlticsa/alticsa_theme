...
if ( ! function_exists( 'chinchilla_trx_addons_get_css' ) ) {
	add_filter( 'chinchilla_filter_get_css', 'chinchilla_trx_addons_get_css', 10, 2 );
	function chinchilla_trx_addons_get_css( $css, $args ) {
...
.sc_icons.sc_icons_plate .sc_icons_item_more_link,
