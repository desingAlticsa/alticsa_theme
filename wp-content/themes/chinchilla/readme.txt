== Chinchilla ==
Version: 1.2.0.0
Copyright: 2021, AncoraThemes
WordPress version: required at least 5.0, tested up to 5.8.1
...
Please install and activate it before starting to use the theme Chinchilla.
...
Theme documentation is available on http://chinchilla.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Chinchilla is Fontello.
